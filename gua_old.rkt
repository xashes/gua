...
(provide (contract-out
          [gua-name (-> (listof yao/c) string?)]
          [random-gua (->* () (3-or-6/c) (listof yao/c))]
          [yao-bian (-> yao/c yao/c)]
          [zong-gua (-> (listof yao/c) (listof yao/c))]
          [cuo-gua (-> (listof yao/c) (listof yao/c))]
          [hu-gua (-> (listof yao/c) (listof yao/c))]
          [jiao-gua (-> (listof yao/c) (listof yao/c))]
          [jiaohu-gua (-> (listof yao/c) (listof yao/c))]
          ))
